on run
	...
	repeat with contact in csvToList(strCSV, {})
		set firstName to first item of contact
		set phoneNumber to second item of contact
		set theDialogText to "Click ok to send texts"
		display dialog theDialogText
		set message to replace(messageTemplate, "<<firstName>>", firstName)
